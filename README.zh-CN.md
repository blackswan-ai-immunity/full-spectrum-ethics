...
- 如果你想理解协议对象与国标、A2A、MCP、FSHI、跨企业审计之间的关系，请先看：[Protocol Mapping Center](./docs/mapping/README.md)。
...
4. [Protocol Mapping Center](./docs/mapping/README.md)：协议映射总入口。
5. [Standards and ecosystem mapping](./docs/mapping/standards-mapping.md)：与 AIP、A2A、MCP、数据治理趋势和 AI 风险框架的关系。
6. [FOR_AGENTS.md](./FOR_AGENTS.md)：给 Agent 和 Agent 框架的机器友好入口。
7. [RFC 0001: Full Spectrum Protocol](./rfcs/0001-full-spectrum-protocol.md)：进入开源提案、争议和迭代流程的协议草案。
8. [RFC 0002: Identity and Capability Declaration](./rfcs/0002-identity-and-capability-declaration.md)：第一组机器可读协议对象。
9. [RFC 0003: Audit Trace Schema](./rfcs/0003-audit-trace-schema.md)：责任与复核审计链。
10. [RFC 0004: RiskAlert Schema](./rfcs/0004-risk-alert-schema.md)：统一风险描述语言。
11. [RFC 0005: Node Classification and External Ethics Profile](./rfcs/0005-node-classification-and-external-ethics-profile.md)：节点分级与外部伦理画像。
12. [RFC 0006: Cross-Enterprise Audit Record Profile](./rfcs/0006-cross-enterprise-audit-record.md)：跨组织审计记录 profile。
13. [外部节点接入指南](./EXTERNAL_NODE_GUIDE.md)：工具节点、兼容节点、候选节点与认证节点边界。
14. [Protocol stack v1.8](./docs/protocols/Full_Spectrum_Agent_Protocol_Stack_v1.8_EN.md)：协议栈总览。
15. [Guardian community whitepaper](./docs/protocols/Guardian_Community_Whitepaper_Compliant.md)：守庙人与治理网络。
16. [Cross-Enterprise Audit Record Mapping](./docs/mapping/cross-enterprise-audit-record-mapping.md)：跨组织审计记录映射。
17. [Digital identity declaration](./docs/protocols/Digital_Identity_Declaration.md)：身份层。
18. [FSHI 客服质检用例](./docs/use-cases/FSHI_Customer_Service_Quality_Inspection.md)：工程化落地样板。
19. [FSHI API Contract Mapping](./docs/mapping/fshi-api-contract-mapping.md)：检测 API 字段如何映射为 RiskAlert 与 AuditTrace。
20. [FSHI 最小样例](./examples/fshi/)：脱敏对话如何映射为 RiskAlert 与 AuditTrace。
21. [Validations](./validations/)：面向产品验证 demo 与商业价值叙事的规划空间。
22. [ROADMAP.md](./ROADMAP.md)：项目路线图。
